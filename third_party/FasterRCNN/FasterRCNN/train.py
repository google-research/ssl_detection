...
from dataset import register_coco, register_balloon, register_voc
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--simple_path',
      action='store_true',
      help='Use direct path rather than automatically generated one')
  parser.add_argument(
      '--logdir',
  ...
  if 'VOC' in cfg.DATA.TRAIN[0]:
    voc_config = [
        ...
        'TEST.RESULT_SCORE_THRESH=0.0001', 'TRAIN.EVAL_PERIOD=40'
    ]
